            ...
            <div class="col-12">
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Consulte os dados dos alunos</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="aluno_editar.php?id=<?=$aluno['id_aluno'];?>"class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <p>Tem certeza que deseja excluir o livro(a) <?=$livro['livro_tirulo'];?></p>
